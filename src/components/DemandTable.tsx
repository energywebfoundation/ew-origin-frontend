    ...
    render() {
        ...
        const data = filteredEnrichedDemandData.map((enrichedDemandData: EnrichedDemandData) => {
            ...
            return [
                ...
                demand.getBitFromDemandMask(DemandProperties.Originator) ? demand.originator.substring(0, 5) + ' ... ' + demand.originator.substring(demand.originator.length - 4, demand.originator.length - 1) : '-',
